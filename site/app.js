(function (root, factory) {
  ...
  var I18N = Object.freeze({
    'zh-CN': Object.freeze({
      'meta.title': 'ChatGPT 会不会重置？· 重置神谕',
      'meta.description': 'ChatGPT 会不会重置？一个把公开信号、历史节奏与行动建议放在一起的非官方额度重置预测站。',
      'skip.toContent': '跳到主要内容',
      'brand.homeLabel': 'ChatGPT 会不会重置？首页',
      'brand.name': 'ChatGPT 会不会重置？',
      'brand.tagline': '重置神谕 · 非官方预测',
      ...
      'forecast.eyebrow': 'THE RESET ORACLE / 001',
      'forecast.title': 'ChatGPT 会不会重置？',
      'forecast.subtitle': '读懂 Tibo 的公开信号与历史节奏，判断现在该烧额度，还是再等等。',
      'forecast.oracleAlt': '一位虚构的重置神谕者手持红色 RESET 按钮的鎏金科技塔罗牌',
      'forecast.oracleTitle': 'THE RESET ORACLE',
      'forecast.oracleCaption': '读取信号，不许愿；看见概率，再做决定。',
    ...
    'en': Object.freeze({
      'meta.title': 'Will ChatGPT Reset? · The Reset Oracle',
      'meta.description': 'Will ChatGPT Reset? An unofficial forecast that combines public signals, historical rhythm, and practical guidance.',
      'skip.toContent': 'Skip to main content',
      'brand.homeLabel': 'Will ChatGPT Reset? home',
      'brand.name': 'Will ChatGPT Reset?',
      'brand.tagline': 'Reset oracle · unofficial',
      ...
      'forecast.eyebrow': 'THE RESET ORACLE / 001',
      'forecast.title': 'Will ChatGPT reset?',
      'forecast.subtitle': 'Read Tibo’s public signals and historical rhythm to decide whether to spend your quota now or wait.',
      'forecast.oracleAlt': 'An original gilded techno-tarot card showing a fictional reset oracle holding a red RESET button',
      'forecast.oracleTitle': 'THE RESET ORACLE',
      'forecast.oracleCaption': 'Read signals, not wishes. See the probability, then decide.',
      ...
      'notification.title': 'Will ChatGPT Reset? probability alert',
      ...
      'share.title': 'Will ChatGPT Reset? unofficial forecast',
      'share.probabilities': '5h {five} · 24h {day} · 48h {twoDay}',
